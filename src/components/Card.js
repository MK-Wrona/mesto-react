...
function Card({card, onCardClick}) {
  ...
  return (
    <div className="grid__wrap">
        <img src={card.link} alt={card.name} className="grid__pic" onClick={handleClick} />
      ...
      <div className="grid__description-container">
        ...
        <div className="grid__like-box">
          <svg className='grid__like-button' width="21" height="19" fill="none" viewBox="0 0 21 19" xmlns="http://www.w3.org/2000/svg">
